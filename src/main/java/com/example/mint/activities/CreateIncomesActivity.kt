...
import com.example.mint.databinding.ActivityCreateIncomesBinding
import com.example.mint.helpers.DbHelper
import java.util.Calendar
import java.util.Locale

class CreateIncomesActivity : AppCompatActivity() {
    private lateinit var binding: ActivityCreateIncomesBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityCreateIncomesBinding.inflate(layoutInflater)
