...
import com.example.mint.activities.CreateIncomesActivity
import com.example.mint.adapters.IncomeAdapter
import com.example.mint.databinding.FragmentIncomesBinding
        ...
        if (username != null) {
            ...
            if (userId != null) {
                ...
                binding.redirectButton.setOnClickListener {
                    startActivity(Intent(requireContext(), CreateIncomesActivity::class.java))
                }
            } else {
