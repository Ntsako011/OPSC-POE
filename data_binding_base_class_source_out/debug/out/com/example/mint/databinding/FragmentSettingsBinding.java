...
public final class FragmentSettingsBinding implements ViewBinding {
  ...
  private FragmentSettingsBinding(@NonNull FrameLayout rootView, @NonNull ImageView logoIv,
      @NonNull LinearLayout mainLL, @NonNull EditText maxGoalEditText,
  ...
  public static FragmentSettingsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentSettingsBinding((FrameLayout) rootView, logoIv, mainLL, maxGoalEditText,
          minGoalEditText, saveButton, titleTv);
    }
